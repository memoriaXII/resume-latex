...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt]
    \resumeItem{Architected and built integrated DEX/yield aggregator platform from 0-to-1, designing scalable trading infrastructure that achieved \$2M+ volume and 7800+ active users within initial launch phase.}
...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt]
    ...
    \resumeItem{Participated in the development of advanced multi-asset liquidity vault (ALP) architecture integrating spot swaps, market making, and leveraged trading with dynamic risk management.}
