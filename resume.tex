...
\begin{itemize}[leftmargin=1.5em, itemsep=0pt, topsep=0pt]
  \item \textbf{Languages:} JavaScript, TypeScript, Rust, Solidity
  ...
  \item \textbf{Tools \& Infrastructure:} Git, Docker, AWS, Jest
\end{itemize}
...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt]
    \resumeItem{Architected and built integrated DEX/yield aggregator platform from 0-to-1, designing scalable trading infrastructure that achieved \$939K+ volume and 6,689+ active users within 8 weeks as sole technical lead.}
