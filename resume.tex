...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt]
    \resumeItem{Architected and built integrated DEX/yield aggregator platform from 0-to-1, designing scalable trading infrastructure that achieved \$1.11M+ volume and 7400+ active users within 8 weeks as sole technical lead.}
